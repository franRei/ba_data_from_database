...
public class DescendantsParser {
    ...
    public void run() throws IOException{
        int count=1;
        String query_proto_germanic = "SELECT * FROM proto_germanic_01_01 order by g_word limit 3500,500";
    ...
    public DescTree parseDescendants(String word, String language, String descendants) throws IOException{
        ...
        try{
            ...
            for (String line : descendants.split("\n")) {
                ...
                while(matcher.find()){
                    boolean borrowed = false; //we change this later if we encounter bor=1, put similar booleans here for further options we want to consider.
                    ...
                    if(templateTag.equals("desc") ||  templateTag.equals("l")){
                        ...
                        newChild = parseDescTree(word_child, language_child);
            ...
            if(!foundSomething){
                ...
                DescTree child = new DescTree("ERROR IN "+word,language);
        ...
        return new DescTree("ERROR IN "+word,language);
        }
    }
    ...
    public DescTree parseDescTree(String raw_word, String language) throws IOException{
        ...
        try{
            ...
            if(!found){
                ...
                String descendants = cut3[1].split("^=")[0];//takes everything up to the next line starting with an '=', or the rest of the file. Hopefully this covers all cases.
